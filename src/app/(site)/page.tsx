...
export const metadata: Metadata = {
  ...
  description: "Consultor SEO y diseñador web freelance en Medellín. WordPress y Shopify que posicionan en Google desde el día 1. Sin agencia, resultados medibles.",
  alternates: { canonical: "https://stivenramirez.com/" },
};

const localBiz = localBusinessSchema({
  name: "Stiven Ramírez - Consultor SEO Medellín",
  description: "Consultor SEO freelance y diseñador web en Medellín.",
  url: SITE_URL,
...
const person = {
  ...
  name: "Stiven Ramírez", url: SITE_URL, jobTitle: "Consultor SEO",
