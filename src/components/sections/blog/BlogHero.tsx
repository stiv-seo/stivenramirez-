      ...
      <Container>
        <FadeIn>
          ...
          >
            Sin rodeos sobre
            <br />
            <span className="text-teal">SEO y diseño web.</span>
          </h1>
          ...
          >
            Artículos prácticos sobre posicionamiento en Google, diseño web y e-commerce
            para pymes colombianas. Sin relleno, sin teoría vacía.
          </p>
        </FadeIn>
      </Container>
    </section>
